...
def run():
    ...
    #train step1
    if os.path.exists(os.path.join('checkpoints', 'best_map_up_data1.t')):
        print('up net exist!')
        print('net best map is:', torch.load(os.path.join('checkpoints', 'best_map_up_data1.t')))
        
    else:
        print('start train up net')
    ...
    if os.path.exists(os.path.join('checkpoints', 'best_map_down_data1.t')):
        print('step 1 down net exist')
        print('net best map is:', torch.load(os.path.join('checkpoints', 'best_map_down_data1.t')))
    else:
        print('start train step1 down net ')
    ...
    del B_data1_up, B_data1_down, B_data1_all,  Q_data1_up, Q_data1_down, Q_data1_all
    del B_data2_up, B_data2_down, B_data2_all,  Q_data2_up, Q_data2_down, Q_data2_all
    ...
    _ ,_ = cal_map(args.dataset, args.dataset2, query_dataloader2, retrieval_dataloader2, args)
...
def load_config():
    ...
    parser.add_argument('--topk', default=23000, type=int,                                   ######
    ...
    parser.add_argument('--ita', default=0.001, type=float,                                      ######
