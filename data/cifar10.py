...
def load_data(root, num_query, num_train, batch_size, num_workers):
    ...
    retrieval_dataset_matrix = CIFAR10('database', transform=transform_make_matrix(), target_transform=Onehot())
    ...
    retrieval_dataloader_matrix = DataLoader(
        retrieval_dataset_matrix,
        batch_size=1000,
        pin_memory=True,
        num_workers=num_workers,
        drop_last=True,
    ...
    return query_dataloader, train_dataloader, retrieval_dataloader, retrieval_dataloader_matrix
...
class CIFAR10(Dataset):
    ...
    def init(root, num_query, num_train):
        ...
        # Split data, targets
        CIFAR10.QUERY_IMG = test_data
        CIFAR10.QUERY_TARGET = test_targets
        CIFAR10.TRAIN_IMG = data[train_index, :]
        CIFAR10.TRAIN_TARGET = targets[train_index]
        CIFAR10.RETRIEVAL_IMG = data
        CIFAR10.RETRIEVAL_TARGET = targets
    ...
    def __getitem__(self, index, mode='norm'):
        ...
        if self.transform is not None and mode =='norm':
            ...
            original_transforms = transforms.Compose([transforms.Resize(64),transforms.ToTensor()])
