...
def load_data(tc, root, num_query, num_train, batch_size, num_workers,
    ...
    if tc == 21:
        ...
        train_dataset = NusWideDatasetTC21(
            root,
            'database_img-100000.txt',
            'database_label_onehot-100000.txt',
...
class NusWideDatasetTC21(Dataset):
    ...
    def __getitem__(self, index, mode='norm'):
        ...
        if self.transform is not None and mode == 'norm':
            ...
            original_transforms = transforms.Compose([transforms.Resize(256),transforms.CenterCrop(224),transforms.ToTensor()])
