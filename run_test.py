...
def load_config():
    ...
    parser.add_argument('--dataset2',
                        help='Dataset2 name.',default='flickr25k')               ######
    parser.add_argument('--root',
                        help='Path of dataset',default='../data-set')   ######
    parser.add_argument('--root2',
                        help='Path of dataset2',default='../data-set/flickr25k/FLICKR25K')  ######
    ...
    parser.add_argument('--num-query2', default=2000, type=int,                               ######
                        help='Number of query data points.(default: 1000)')
    ...
    parser.add_argument('--topk2', default=23000, type=int,                                   ######
                        help='Calculate map of top k.(default: all)')
    ...
    parser.add_argument('--ita', default=0.3, type=float,                                      ######
